...
export const checkMin = async (value: any, rule: FormItemRule) => {
...
export const checkMax = async (value: any, rule: FormItemRule) => {
...
export const checkRequired = async (value: any, rule: FormItemRule) => {
...
export const checkPattern = (value: any, rule: FormItemRule) => {
